    ...
    return (
        <div className="card card-compact w-[305px] bg-white border border-solid border-[#DBDBDB] rounded-[6.46px] m-5">
            <figure className="relative px-2 mt-2">
                <img src={thumbnail} alt="Shoes" className="rounded-[6.46px] w-[282.21px] h-[149.18px]"/>
                <div className="absolute top-2 right-5 rounded-full bg-[#6100FF] text-white font-[600]
                    text-[14px] leading-[18.9px] py-1 px-4 z-10">
                        -{discountPercentage}%
                </div>
            </figure>
